...
//    benchmark.addIteratedTest(new GroupByLinkedListScala(10000), defaultIterationsCount/2000)
    benchmark.addIteratedTest(new MultiplyElementsOfTwoArraysJava(10000), defaultIterationsCount/2000)
    benchmark.addIteratedTest(new MultiplyElementsOfTwoArrayListsJava(10000), defaultIterationsCount/2000)
    benchmark.addIteratedTest(new MultiplyElementsOfTwoLinkedListsJava(10000), defaultIterationsCount/2000)
    benchmark.addIteratedTest(new MultiplyElementsOfTwoArraysScala(10000), defaultIterationsCount/2000)
    benchmark.addIteratedTest(new MultiplyElementsOfTwoLinkedListsScala(10000), defaultIterationsCount/2000)
